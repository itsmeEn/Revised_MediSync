      ...
      <div class="drawer-content">
        ...
        <div class="user-profile-section">
          ...
          <div class="user-info">
            ...
            <p class="user-role">{{ userProfile.department || 'Loading department...' }}</p>
            <q-chip 
              :color="userProfile.verification_status === 'approved' ? 'positive' : 'negative'" 
              text-color="white" 
              size="sm"
          ...
          <q-card class="greeting-card">
            <q-card-section class="greeting-content">
              <div class="greeting-text">
                ...
                <p class="greeting-subtitle">Manage patient care and medical records</p>
              </div>
                ...
                >
                  ...
                  <div class="patient-actions">
                    ...
                    <q-btn
                      ...
                      color="positive"
                      size="sm"
                      @click.stop="assessPatient(patient)"
                    />
                  </div>
                </div>
              </div>
...
const assessPatient = (patient: Patient) => {
  $q.notify({
    type: 'info',
    message: `Starting assessment for ${patient.full_name}`,
    position: 'top'
  })
  // Navigate to patient assessment page
...
// Lifecycle
onMounted(() => {
  console.log('🚀 NursePatientManagement component mounted')
...
<style scoped>
/* Same styles as DoctorPatientManagement but with nurse-specific colors */
.prototype-header {
  background: linear-gradient(135deg, #4a7c59 0%, #286660 100%);
...
.greeting-title {
  ...
  color: #333;
  margin: 0 0 10px 0;
  background: linear-gradient(135deg, #4a7c59, #286660);
